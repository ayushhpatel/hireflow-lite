...
public class JobController {
    ...
    @GetMapping
    public ResponseEntity<List<JobResponse>> getAllJobs(@AuthenticationPrincipal CustomUserDetails userDetails) {
        return ResponseEntity.ok(jobService.getAllJobs(userDetails.getOrgId()));
    }
